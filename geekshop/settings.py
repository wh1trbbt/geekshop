...
SECRET_KEY = (
    "django-insecure-3uq1x=6q^w3(90zth7p4rn-daj-l7^hnrdja)f8*l#0t4*_e)#"
)
...
SOCIAL_AUTH_GOOGLE_KEY = google_auth["client_id"]
SOCIAL_AUTH_GOOGLE_SECRET = google_auth["client_secret"]
